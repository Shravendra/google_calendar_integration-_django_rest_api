...
Problem: In this assignment i have implemented google calendar integration using django rest api. 
I used the OAuth2 mechanism to get users calendar access. Below are detail of API endpoint and corresponding views which you need to implement
