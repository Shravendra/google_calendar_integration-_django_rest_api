...
Problem: In this assignment i have to implement google calendar integration using django rest api. 
I need to use the OAuth2 mechanism to get users calendar access. Below are detail of API endpoint and corresponding views which you need to implement
...
1. Handle redirect request sent by google with code for token. I
